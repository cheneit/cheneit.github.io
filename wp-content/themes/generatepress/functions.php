...
function tu_custom_copyright() {
    ?>
    © <script>document.write(new Date().getFullYear());</script> ZhouGroup • <a href="http://beian.miit.gov.cn/" target="_blank" rel="nofollow noopener"><img src="https://www.seoshipin.cn/wp-content/uploads/beian.png">豫ICP备2024041732号</a>
    <?php
}